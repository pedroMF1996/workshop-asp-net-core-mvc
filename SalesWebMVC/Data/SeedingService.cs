    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (!(_context.Departments.Any() || _context.Sellers.Any() || _context.SalesRecords.Any()))
            {
                ...
                SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SaleStatus.Canceld, s4);
                ...
                SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 10, 19), 11000.0, SaleStatus.Canceld, s2);
